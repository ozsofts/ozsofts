...
import net.ozsofts.utils.ui.freemarker.OverrideDirective.TemplateDirectiveBodyOverrideWraper;
...
public class DirectiveUtils {
	...
	public static void exposeRapidMacros(Configuration conf) {
		...
		conf.setSharedVariable("friendlyTime", new FriendlyTimeMethod());
		conf.setSharedVariable("formatDateTime", new DateFormatMethod());
		conf.setSharedVariable("subString", new SubStringMethod());
		conf.setSharedVariable("URLEncode", new URLEncodeMethod());
		conf.setSharedVariable("URLDecode", new URLDecodeMethod());
	}
